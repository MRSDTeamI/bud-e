...
if("TRUE" STREQUAL "TRUE")
  set(rosaria_SOURCE_PREFIX /home/praveen/Documents/ROS/tmp/rosaria/src/rosaria)
  set(rosaria_DEVEL_PREFIX /home/praveen/Documents/ROS/tmp/rosaria/devel)
  set(rosaria_INSTALL_PREFIX "")
  set(rosaria_PREFIX ${rosaria_DEVEL_PREFIX})
else()
  set(rosaria_SOURCE_PREFIX "")
  set(rosaria_DEVEL_PREFIX "")
  set(rosaria_INSTALL_PREFIX /home/praveen/Documents/ROS/tmp/rosaria/install)
...
if(NOT "/home/praveen/Documents/ROS/tmp/rosaria/devel/include" STREQUAL "")
  set(rosaria_INCLUDE_DIRS "")
  set(_include_dirs "/home/praveen/Documents/ROS/tmp/rosaria/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosaria' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/praveen/Documents/ROS/tmp/rosaria/src/rosaria/${idir}'.  Ask the maintainer 'Srećko Jurić-Kavelj <srecko.juric-kavelj@fer.hr>, Ivan Marković <ivan.markovic@fer.hr>, Reed Hedges <reed.hedges@aedpt.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/praveen/Documents/ROS/tmp/rosaria/devel/lib;/home/praveen/Documents/ROS/tmp/rosaria/devel/lib;/opt/ros/indigo/lib)
