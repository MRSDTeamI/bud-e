...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosaria' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/praveen/Documents/ROS/tmp/rosaria/install/${idir}'.  Ask the maintainer 'Srećko Jurić-Kavelj <srecko.juric-kavelj@fer.hr>, Ivan Marković <ivan.markovic@fer.hr>, Reed Hedges <reed.hedges@aedpt.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/praveen/Documents/ROS/tmp/rosaria/install/lib;/home/praveen/Documents/ROS/tmp/rosaria/devel/lib;/opt/ros/indigo/lib)
